...
export const Logo = ({ className = "", size = "md" }: LogoProps) => {
  ...
  // For light theme, use inline SVG with blue text
  if (theme === "light") {
    return (
      <svg 
      ...
      >
        <path 
          ...
          fill="url(#paint0_linear_logo_light)" 
        />
        <path 
          ...
          fill="url(#paint1_linear_logo_light)" 
        />
        <text 
          fill="#004EF6" 
        ...
        <defs>
          ...
          >
            <stop stopColor="#3DFFEC" />
            <stop offset="0.5" stopColor="#00D7CC" />
            <stop offset="1" stopColor="#004EF6" />
          </linearGradient>
          <linearGradient 
            id="paint1_linear_logo_light" 
            x1="20.414" 
            y1="150.168" 
            x2="54.1142" 
            y2="-5.3753" 
  ...
  // For dark theme, use inline SVG (original)
  return (
    <svg 
      className={`${sizeClasses[size]} ${className}`} 
      viewBox="0 0 442 149" 
